...
class MetaEntity
  ...
  # @return [Meta, Hash] the current Meta data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Meta fields)
  def match_get
  ...
  # Load a single Meta.
  #
  # @param reqmatch [MetaLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Meta.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Meta, Hash] the loaded Meta; raises AgentGatewayError on failure
