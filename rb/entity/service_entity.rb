# AgentGateway SDK Service entity
...
class ServiceEntity
  ...
  # @return [Service, Hash] the loaded Service; raises AgentGatewayError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Service>, Array] the matching Service items; raises AgentGatewayError on failure
