...
class ServiceEntityTest < Minitest::Test
  ...
  def test_stream
    ...
    base = AgentGatewaySDK.test(seed, nil)
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set AGENT_GATEWAY_TEST_SERVICE_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def service_basic_setup(extra)
  ...
  entid_env_raw = ENV["AGENT_GATEWAY_TEST_SERVICE_ENTID"]
