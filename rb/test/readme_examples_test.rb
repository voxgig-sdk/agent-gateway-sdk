...
#      offline in seeded test mode (AgentGatewaySDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "AgentGateway_sdk.rb")
  SDK_CLASS = "AgentGatewaySDK"
