...
class BalanceEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set AGENTGATEWAY_TEST_BALANCE_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def balance_basic_setup(extra)
  ...
  entid_env_raw = ENV["AGENTGATEWAY_TEST_BALANCE_ENTID"]
