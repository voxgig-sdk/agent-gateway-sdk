...
_runner = makeRunner(TEST_JSON_FILE, AgentGatewaySDK.test(None, None))
...
def _auth_credential():
    ...
    ctx.spec = AgentGatewaySpec({"headers": {}, "query": {}})
    try:
...
class TestPrimaryUtility:
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = AgentGatewaySDK.test(None, setup.get('a') or {})
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = AgentGatewaySDK.test(None, setup.get('a') or {})
