...
class AgentGatewayTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = AgentGatewayTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = AgentGatewayTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = AgentGatewayTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
