...
class AgentGatewayTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = AgentGatewayTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = AgentGatewayTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = AgentGatewayTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
