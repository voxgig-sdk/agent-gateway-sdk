...
from projectname_sdk.core.control import AgentGatewayControl
...
class AgentGatewayContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, AgentGatewaySpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, AgentGatewayResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, AgentGatewayResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return AgentGatewayError(code, msg, self)
