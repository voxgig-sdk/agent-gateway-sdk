...
// AgentGateway SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class AgentGatewayTransformResponse
{
    public static function call(AgentGatewayContext $ctx): mixed
    {
        ...
        $transform = AgentGatewayHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
