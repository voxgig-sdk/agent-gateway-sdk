...
// AgentGateway SDK utility: make_options

class AgentGatewayMakeOptions
{
    ...
    public static function call(AgentGatewayContext $ctx): array
    {
        ...
        //
        // `AgentGatewaySchema::optspec()` is built from the model:
        ...
        $optspec = AgentGatewaySchema::optspec();
