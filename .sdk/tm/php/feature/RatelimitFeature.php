...
// AgentGateway SDK ratelimit feature
...
class AgentGatewayRatelimitFeature extends AgentGatewayBaseFeature
{
    ...
    private function _acquire(AgentGatewayContext $ctx): void
    {
    ...
    private function _track(AgentGatewayContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
