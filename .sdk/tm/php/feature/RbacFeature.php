...
class AgentGatewayRbacFeature extends AgentGatewayBaseFeature
{
    ...
    private function _required(AgentGatewayContext $ctx): ?string
    {
    ...
    private function _reject(AgentGatewayContext $ctx, string $required): void
    {
    ...
    private function _track(AgentGatewayContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
