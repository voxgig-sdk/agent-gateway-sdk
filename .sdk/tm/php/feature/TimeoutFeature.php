...
// AgentGateway SDK timeout feature
...
class AgentGatewayTimeoutFeature extends AgentGatewayBaseFeature
{
    ...
    private function _with_timeout(AgentGatewayContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(AgentGatewayContext $_ctx, float $ms): void
    {
        $client = $this->client;
