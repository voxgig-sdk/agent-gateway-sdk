...
// AgentGateway SDK clienttrack feature
...
class AgentGatewayClienttrackFeature extends AgentGatewayBaseFeature
{
    ...
    public function PostConstruct(AgentGatewayContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'AgentGateway-SDK';
