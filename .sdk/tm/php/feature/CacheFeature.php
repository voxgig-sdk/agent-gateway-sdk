...
// AgentGateway SDK cache feature
...
class AgentGatewayCacheFeature extends AgentGatewayBaseFeature
{
    ...
    private function _through(AgentGatewayContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
