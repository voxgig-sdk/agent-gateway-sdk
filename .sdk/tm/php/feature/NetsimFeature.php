...
// AgentGateway SDK netsim feature
...
class AgentGatewayNetsimFeature extends AgentGatewayBaseFeature
{
    ...
    private function _simulate(AgentGatewayContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(AgentGatewayContext $ctx, array $applied): void
    {
        $client = $this->client;
