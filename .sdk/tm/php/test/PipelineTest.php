...
// AgentGateway SDK pipeline test
//
...
{
    private static function utility(): AgentGatewayUtility
    {
        return new AgentGatewayUtility();
    }
    ...
    private static function ctx(array $over = []): AgentGatewayContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new AgentGatewayContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new AgentGatewayOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof AgentGatewayError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new AgentGatewayOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = AgentGatewayMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new AgentGatewayOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = AgentGatewayMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new AgentGatewayOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = AgentGatewayMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new AgentGatewaySpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = AgentGatewayMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new AgentGatewayResponse([]),
            'result' => new AgentGatewayResult([]),
        ]);
        [, $err] = AgentGatewayMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new AgentGatewaySpec([]),
            'response' => null,
            'result' => new AgentGatewayResult([]),
        ]);
        [, $err] = AgentGatewayMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new AgentGatewaySpec(['step' => 's']),
            'response' => new AgentGatewayResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new AgentGatewayResult([]),
        ]);
        [, $err] = AgentGatewayMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new AgentGatewaySpec(['step' => 's']),
            'response' => new AgentGatewayResponse(self::resp(200, ['v' => 1])),
            'result' => new AgentGatewayResult([]),
        ]);
        [, $err] = AgentGatewayMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new AgentGatewaySpec(['step' => 's']),
            'response' => new AgentGatewayResponse(self::resp(200, ['v' => 2])),
            'result' => new AgentGatewayResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        AgentGatewayMakeResponse::call($ctx);
    ...
    {
        $preset = new AgentGatewayResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new AgentGatewaySpec([]),
            'response' => new AgentGatewayResponse([]),
            'result' => new AgentGatewayResult([]),
        ...
        [$got, $err] = AgentGatewayMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new AgentGatewayResult([])]);
        [, $err] = AgentGatewayMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new AgentGatewaySpec([]), 'result' => null]);
        [, $err] = AgentGatewayMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new AgentGatewaySpec(['step' => 's']),
            'result' => new AgentGatewayResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new AgentGatewayOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = AgentGatewayMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new AgentGatewaySpec(['step' => 's']),
            'result' => new AgentGatewayResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new AgentGatewayOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = AgentGatewayMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new AgentGatewayResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new AgentGatewaySpec([]),
            'result' => new AgentGatewayResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = AgentGatewayMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = AgentGatewayMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new AgentGatewayError('boom', 'boom');
        $utility->fetcher = function (AgentGatewayContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new AgentGatewaySpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = AgentGatewayMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (AgentGatewayContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = AgentGatewayMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(AgentGatewayResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        AgentGatewayMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (AgentGatewayContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new AgentGatewaySpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = AgentGatewayMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new AgentGatewayResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new AgentGatewaySpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = AgentGatewayMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = AgentGatewayMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = AgentGatewayMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new AgentGatewayResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, AgentGatewayDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new AgentGatewayResult(['ok' => false])]);
        $this->expectException(AgentGatewayError::class);
        AgentGatewayDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new AgentGatewayResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', AgentGatewayMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        AgentGatewayMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new AgentGatewayBaseFeature();
        $b = new AgentGatewayBaseFeature();
        AgentGatewayFeatureAdd::call($ctx, $a);
        AgentGatewayFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): AgentGatewayBaseFeature
    {
        $f = new AgentGatewayBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        AgentGatewayFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?AgentGatewaySpec $spec): AgentGatewayContext
    {
    ...
    private static function auth_bags(): AgentGatewaySpec
    {
        return new AgentGatewaySpec(['headers' => [], 'query' => []]);
    }
    ...
    private static function auth_probe(array $options): ?array
    {
        ...
        AgentGatewayPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = AgentGatewayPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new AgentGatewayResponse(['headers' => null]),
            'result' => new AgentGatewayResult([]),
        ]);
        AgentGatewayResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        AgentGatewayResultBody::call($ctx);
