// Command AgentGateway-mcp is an MCP server exposing the AgentGateway
// SDK as MCP tools.
//
// Two tools are registered:
//
//	AgentGateway_list  — list records of an entity
//	AgentGateway_load  — load a single record of an entity
//
