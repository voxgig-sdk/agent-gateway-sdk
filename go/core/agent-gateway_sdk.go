...
func (sdk *AgentGatewaySDK) OptionsMap() map[string]any {
...
func (sdk *AgentGatewaySDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *AgentGatewaySDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *AgentGatewaySDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *AgentGatewaySDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *AgentGatewaySDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *AgentGatewaySDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("AgentGatewaySDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *AgentGatewaySDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *AgentGatewaySDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("AgentGatewaySDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *AgentGatewaySDK {
	...
	sdk := NewAgentGatewaySDK(sdkopts)
	sdk.Mode = "test"
