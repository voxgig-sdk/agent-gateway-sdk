...
const testSeed = `map[string]any{"entity": map[string]any{"analytics": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "api_key": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "balance": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "meta": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "payment": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "service": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
