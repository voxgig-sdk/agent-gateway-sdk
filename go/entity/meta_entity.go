...
func NewMetaEntity(client *core.AgentGatewaySDK, entopts map[string]any) *MetaEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *MetaEntity) GetName() string { return e.name }
...
func (e *MetaEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *MetaEntity) Deleted() bool {
	return e.deleted
}


func (e *MetaEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewMetaEntity(e.client, opts)
}

func (e *MetaEntity) Data(args ...any) any {
...
func (e *MetaEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *MetaEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *MetaEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *MetaEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *MetaEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *MetaEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *MetaEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
