...
```bash
go mod edit -replace github.com/voxgig-sdk/agent-gateway-sdk/go=../path/to/github.com/voxgig-sdk/agent-gateway-sdk/go
```
...
```
github.com/voxgig-sdk/agent-gateway-sdk/go/
...
The root package (`github.com/voxgig-sdk/agent-gateway-sdk/go`) re-exports everything needed
