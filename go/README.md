# AgentGateway Golang SDK

The Golang SDK for the AgentGateway API. Provides an entity-oriented interface using standard Go conventions — no generics required, data flows as `map[string]any`.


## Install
```bash
go get github.com/voxgig-sdk/agent-gateway-sdk
```
...
```bash
go mod edit -replace github.com/voxgig-sdk/agent-gateway-sdk=../path/to/github.com/voxgig-sdk/agent-gateway-sdk
```
...
```go
func TestSDK(testopts map[string]any, sdkopts map[string]any) *AgentGatewaySDK
```
...
| `Analytics` | `(data map[string]any) AgentGatewayEntity` | Create a Analytics entity instance. |
| `ApiKey` | `(data map[string]any) AgentGatewayEntity` | Create a ApiKey entity instance. |
| `Balance` | `(data map[string]any) AgentGatewayEntity` | Create a Balance entity instance. |
| `Meta` | `(data map[string]any) AgentGatewayEntity` | Create a Meta entity instance. |
| `Payment` | `(data map[string]any) AgentGatewayEntity` | Create a Payment entity instance. |
| `Service` | `(data map[string]any) AgentGatewayEntity` | Create a Service entity instance. |

### Entity interface (AgentGatewayEntity)

All entities implement the `AgentGatewayEntity` interface.
...
```
github.com/voxgig-sdk/agent-gateway-sdk/
├── agent-gateway.go        # Root package — type aliases and constructors
...
The root package (`github.com/voxgig-sdk/agent-gateway-sdk`) re-exports everything needed
