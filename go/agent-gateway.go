...
// instead of `sdk.NewAgentGatewaySDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *AgentGatewaySDK  { return NewAgentGatewaySDK(nil) }
func Test() *AgentGatewaySDK { return TestSDK(nil, nil) }
