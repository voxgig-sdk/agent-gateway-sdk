...
class AgentGatewayTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = AgentGatewayTestRunner.getenv("AGENTGATEWAY_TEST_LIVE")
        override = AgentGatewayTestRunner.getenv("AGENTGATEWAY_TEST_OVERRIDE")
        ...
        explain = AgentGatewayTestRunner.getenv("AGENTGATEWAY_TEST_EXPLAIN")
