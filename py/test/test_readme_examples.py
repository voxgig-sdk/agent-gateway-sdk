# AgentGateway SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions AgentGatewaySDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both AgentGatewaySDK(...) and AgentGatewaySDK.test(...) become
#      AgentGatewaySDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "agentgateway_sdk"
_SDK_CLASS = "AgentGatewaySDK"
