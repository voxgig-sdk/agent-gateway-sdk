...
from agentgateway_sdk.utility import register

# Load features
from agentgateway_sdk.feature.base_feature import AgentGatewayBaseFeature
from agentgateway_sdk.features import _has_feature, _make_feature
...
class AgentGatewaySDK:
    ...
    def _op_denied(self, op):
        ...
        return {
            "ok": False,
            "err": Exception(
                "AgentGatewaySDK: " + op + ": operation not allowed by"
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("AgentGatewaySDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Analytics(self, data=None) -> "AnalyticsEntity":
        ...
        from agentgateway_sdk.entity.analytics_entity import AnalyticsEntity
    ...
    def ApiKey(self, data=None) -> "ApiKeyEntity":
        ...
        from agentgateway_sdk.entity.api_key_entity import ApiKeyEntity
    ...
    def Balance(self, data=None) -> "BalanceEntity":
        ...
        from agentgateway_sdk.entity.balance_entity import BalanceEntity
        return BalanceEntity(self, data)


    def Meta(self, data=None) -> "MetaEntity":
        """Entity factory: client.Meta().list() / client.Meta().load({"id": ...})."""
        from agentgateway_sdk.entity.meta_entity import MetaEntity
    ...
    def Payment(self, data=None) -> "PaymentEntity":
        ...
        from agentgateway_sdk.entity.payment_entity import PaymentEntity
    ...
    def Service(self, data=None) -> "ServiceEntity":
        ...
        from agentgateway_sdk.entity.service_entity import ServiceEntity
