...
class AgentGatewayFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; AgentGatewaySDK/1.0)';
    ...
    public static function call(AgentGatewayContext $ctx, string $fullurl, array $fetchdef): array
    {
