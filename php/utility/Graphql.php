...
// AgentGateway SDK utility: graphql
//
...
class AgentGatewayGraphql
{
    ...
    // equivalent.
    public static function body(AgentGatewayContext $ctx): mixed
    {
    ...
    public static function errors(AgentGatewayContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
