...
// AgentGateway SDK audit feature
...
class AgentGatewayAuditFeature extends AgentGatewayBaseFeature
{
    ...
    private function _emit(AgentGatewayContext $ctx, string $outcome): void
    {
