...
// AgentGateway SDK telemetry feature
...
class AgentGatewayTelemetryFeature extends AgentGatewayBaseFeature
{
    ...
    private function _close(AgentGatewayContext $ctx, bool $ok): void
    {
