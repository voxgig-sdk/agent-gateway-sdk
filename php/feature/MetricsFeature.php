...
// AgentGateway SDK metrics feature
...
class AgentGatewayMetricsFeature extends AgentGatewayBaseFeature
{
    ...
    private function _record(AgentGatewayContext $ctx, bool $ok): void
    {
