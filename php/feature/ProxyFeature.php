...
// AgentGateway SDK proxy feature
...
class AgentGatewayProxyFeature extends AgentGatewayBaseFeature
{
    ...
    public function init(AgentGatewayContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (AgentGatewayContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
