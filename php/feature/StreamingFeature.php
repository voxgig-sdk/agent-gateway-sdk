...
// AgentGateway SDK streaming feature
...
class AgentGatewayStreamingFeature extends AgentGatewayBaseFeature
{
    ...
    private function _iterate(AgentGatewayResult $result): \Generator
    {
    ...
    private function _streamable(AgentGatewayContext $ctx): bool
    {
