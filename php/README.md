# AgentGateway PHP SDK

The PHP SDK for the AgentGateway API. Provides an entity-oriented interface using PHP conventions.
...
```php
[$result, $err] = $client->Analytics(null)->load(["id" => "example_id"], null);
...
[$result, $err] = $client->AgentGateway(null)->load(
    ["id" => "test01"], null
);
...
The main class (`agentgateway_sdk.php`) exports the SDK class
