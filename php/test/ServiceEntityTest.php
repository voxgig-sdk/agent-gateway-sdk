...
class ServiceEntityTest extends TestCase
{
    ...
    public function test_stream(): void
    {
        ...
        $base = AgentGatewaySDK::test($seed, null);
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set AGENT_GATEWAY_TEST_SERVICE_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function service_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("AGENT_GATEWAY_TEST_SERVICE_ENTID");
