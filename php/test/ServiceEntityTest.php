...
class ServiceEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set AGENTGATEWAY_TEST_SERVICE_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function service_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("AGENTGATEWAY_TEST_SERVICE_ENTID");
