...
class AnalyticsEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set AGENTGATEWAY_TEST_ANALYTICS_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function analytics_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("AGENTGATEWAY_TEST_ANALYTICS_ENTID");
