...
// AgentGateway SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (AgentGatewaySDK::test)
...
{
    private const SDK_CLASS = 'AgentGatewaySDK';
    ...
    private const SDK_BASE = 'agentgateway_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../agentgateway_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
