...
// AgentGateway SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = AgentGatewayOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(AgentGatewayOmni::structfix($now, Struct::undef()))
                        !== json_encode(AgentGatewayOmni::structfix($val, Struct::undef()))) {
