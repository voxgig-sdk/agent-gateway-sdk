...
class MetaDirectTest extends TestCase
{
    public function test_direct_load_meta(): void
    {
        $setup = meta_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-meta", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
