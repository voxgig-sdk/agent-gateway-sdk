...
// AgentGateway SDK utility type

class AgentGatewayUtility
{
    ...
    public static function copy(AgentGatewayUtility $src): AgentGatewayUtility
    {
        $u = new AgentGatewayUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
