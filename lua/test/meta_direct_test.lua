...
describe("MetaDirect", function()
  it("should direct-load-meta", function()
    local setup = meta_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-meta", setup.live and "live" or "unit")
...
function meta_direct_setup(mockres)
