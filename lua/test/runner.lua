...
function runner.env_override(m)
  local live = runner.getenv("AGENT_GATEWAY_TEST_LIVE")
  local override = runner.getenv("AGENT_GATEWAY_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("AGENT_GATEWAY_TEST_EXPLAIN")
