...
function runner.env_override(m)
  local live = runner.getenv("AGENTGATEWAY_TEST_LIVE")
  local override = runner.getenv("AGENTGATEWAY_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("AGENTGATEWAY_TEST_EXPLAIN")
