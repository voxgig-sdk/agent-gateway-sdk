...
local SDK_MODULE = "agent-gateway_sdk"
...
-- data to return.
local TEST_SEED = '{ entity = { ["analytics"] = { ["test01"] = { id = "test01" } }, ["api_key"] = { ["test01"] = { id = "test01" } }, ["balance"] = { ["test01"] = { id = "test01" } }, ["meta"] = { ["test01"] = { id = "test01" } }, ["payment"] = { ["test01"] = { id = "test01" } }, ["service"] = { ["test01"] = { id = "test01" } } } }'
