...
describe("PaymentDirect", function()
  it("should direct-load-payment", function()
    local setup = payment_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-payment", setup.live and "live" or "unit")
