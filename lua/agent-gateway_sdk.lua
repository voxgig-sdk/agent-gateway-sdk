...
local AgentGatewaySDK = {}
AgentGatewaySDK.__index = AgentGatewaySDK
...
AgentGatewaySDK._make_feature = _make_feature


function AgentGatewaySDK.new(options)
  local self = setmetatable({}, AgentGatewaySDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function AgentGatewaySDK:options_map()
...
function AgentGatewaySDK:get_utility()
  return Utility.copy(self._utility)
end


function AgentGatewaySDK:get_root_ctx()
  return self._rootctx
end


function AgentGatewaySDK:prepare(fetchargs)
...
function AgentGatewaySDK:direct(fetchargs)
...
-- by passing it.
function AgentGatewaySDK:_raw_request(fetchargs)
  local utility = self._utility
...
function AgentGatewaySDK:graphql(query, variables, ctrl)
  ...
  if type(errors) == "table" and 0 < #errors then
    ...
    res.ok = false
    res.err = "AgentGatewaySDK: graphql: " .. msg
    res.graphql = errors
  end
...
function AgentGatewaySDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = AgentGatewaySDK.new(sdkopts)
  sdk.mode = "test"
