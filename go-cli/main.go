// Command AgentGateway-cli is a CLI + REPL for the AgentGateway SDK,
...
const prompt = "agent-gateway"

// entitiesHelp is the space-separated entity list shown by /help.
const entitiesHelp = "analytics api_key balance meta payment service"
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      AGENT_GATEWAY_APIKEY (api key), AGENT_GATEWAY_BASE (base url override)")
