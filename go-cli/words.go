...
func registerSDKWords(r *eng.Registry, client *sdk.AgentGatewaySDK) {
...
func runOp(client *sdk.AgentGatewaySDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
