...
AQL-driven CLI and REPL for the AgentGateway SDK. Positional arguments are
...
./agent-gateway-cli list analytics
./agent-gateway-cli load 1 analytics
./agent-gateway-cli load '{id:1}' analytics
