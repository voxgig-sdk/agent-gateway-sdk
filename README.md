...
34 production-ready API services for AI agents.

Learn more about Agent Gateway at [agent-gateway-kappa.vercel.app](https://agent-gateway-kappa.vercel.app).
...
This SDK exposes the API as a small set of **semantic entities** — Analytics, ApiKey, Balance, Meta, Payment and Service — that you
...
| --- | --- | --- |
| **Analytics** | The Analytics entity (load). | `/api/stats` |
