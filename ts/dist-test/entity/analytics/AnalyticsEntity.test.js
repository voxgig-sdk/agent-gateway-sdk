...
(0, node_test_1.describe)('AnalyticsEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        (0, node_assert_1.default)(null != analytics_ref01_data_dt0);
    });
});
function basicSetup(extra) {
    ...
    const idmapEnvVal = process.env['AGENT_GATEWAY_TEST_ANALYTICS_ENTID'];
    ...
    idmap = env['AGENT_GATEWAY_TEST_ANALYTICS_ENTID'];
