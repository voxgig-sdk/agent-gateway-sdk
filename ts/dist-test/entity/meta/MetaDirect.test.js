...
(0, node_test_1.describe)('MetaDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.AgentGatewaySDK({
    ...
    (0, node_test_1.test)('direct-load-meta', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-meta', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.AGENT_GATEWAY_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.AgentGatewaySDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
            apikey: env.AGENT_GATEWAY_APIKEY,
        }));
        let idmap = env['AGENT_GATEWAY_TEST_META_ENTID'];
    ...
    const client = new __1.AgentGatewaySDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=MetaDirect.test.js.map