...
function envOverride(m) {
    if ('TRUE' === process.env.AGENT_GATEWAY_TEST_LIVE ||
        'TRUE' === process.env.AGENT_GATEWAY_TEST_OVERRIDE) {
    ...
    m.AGENT_GATEWAY_TEST_EXPLAIN = process.env.AGENT_GATEWAY_TEST_EXPLAIN || m.AGENT_GATEWAY_TEST_EXPLAIN;
    return m;
}
