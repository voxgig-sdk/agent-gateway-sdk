...
exports.SDK = exports.AgentGatewaySDK = exports.AgentGatewayEntityBase = exports.BaseFeature = exports.config = exports.stdutil = void 0;
...
Object.defineProperty(exports, "AgentGatewayEntityBase", { enumerable: true, get: function () { return AgentGatewayEntityBase_1.AgentGatewayEntityBase; } });
...
class AgentGatewaySDK {
    ...
    async direct(fetchargs) {
        if (!this._options.allow.op.includes('direct')) {
            return {
                ok: false,
                err: new Error('AgentGatewaySDK: direct: operation not allowed by' +
    ...
    async graphql(query, variables, ctrl) {
        ...
        if (!options.allow.op.includes('graphql')) {
            return {
                ok: false,
                err: new Error('AgentGatewaySDK: graphql: operation not allowed by' +
        ...
        if (null != errors && Array.isArray(errors) && 0 < errors.length) {
            ...
            const err = new Error('AgentGatewaySDK: graphql: ' +
...
exports.AgentGatewaySDK = AgentGatewaySDK;
const SDK = AgentGatewaySDK;
exports.SDK = SDK;
//# sourceMappingURL=AgentGatewaySDK.js.map